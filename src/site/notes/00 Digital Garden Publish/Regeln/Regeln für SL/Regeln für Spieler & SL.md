---
{"dg-publish":true,"dg-path":"Regeln/Regeln für SL/Regeln für Spieler & SL.md","permalink":"/Regeln/Regeln für SL/Regeln für Spieler & SL/","dg-note-properties":{}}
---
...
**Im Kampf**: siehe [[00 Digital Garden Publish/Regeln/Regeln für SL/Regeln für Spieler & SL#Kampf\|#Kampf]] 

**Außerhalb vom Kampf**: siehe [[00 Digital Garden Publish/Regeln/Regeln für SL/Regeln für Spieler & SL#Zeit vergeht\|#Zeit vergeht]]
...
**Fortbewegung**: siehe [[00 Digital Garden Publish/Regeln/Regeln für SL/Regeln für Spieler & SL#Tagesabschnitt\|#Tagesabschnitt]]

---

## Distanz / Entfernung

- **Direkt**: 1,5m (direkt angrenzendes Grid-Feld)
- **Doppelt-Direkt**: 3m (2 Grid-Felder)
- **Nah**: Bis zu 9m (6 Grid-Felder)
- **Doppelt-Nah**: Bis zu 18m (12 Grid-Felder)
- **Fern**: Bis zu 36m (24 Grid-Felder)
- **Extrem**: Bis zu 72m (48 Grid-Felder) - nur spezielle Fernkampfwaffen; Angriffe erfolgen mit *Nachteil*.
...
Angriff im Nahkampf (*Direkt*) oder Fernkampf (*Nah* oder *Fern*); siehe [[00 Digital Garden Publish/Regeln/Regeln für SL/Regeln für Spieler & SL#Distanz / Entfernung\|#Distanz / Entfernung]]
...
siehe [[00 Digital Garden Publish/Regeln/Regeln für SL/Regeln für Spieler & SL#Magie / Zaubern\|#Magie / Zaubern]]
...
- Erhalte neue Titel, Zauber und Talentverbesserungen, die bei deiner Klassenbeschreibung für dein Level aufgeführt sind. 
- Erreichst du Level du Level 1, 3, 5, 7 oder 9, würfel ein neues Klassentalent aus.
- Würfle den Trefferwürfel deiner Klasse und addiere das Ergebnis zu deinen maximalen TP.
...
**Gefahr fürs Licht**: GES-Probe SG 12, um bei Angriff, Wind o.ä. Erlöschen bzw. Fallenlassen zu vermeiden.

**Fallenlassen einer Fackel**: Wirf **1d6** (ggf. mit Malus wenn Boden feucht, Nass o.ä.):
- **1**: Aus und zerbrochen. Das Licht erlischt sofort, die Fackel ist zerstört.
- **2–6**: Kein Effekt. Die Fackel übersteht den Sturz unbeschadet und brennt am Boden liegend weiter.

**Improvisierter Fackelbau**: Eine Fackel lässt sich in 2 Runden herstellen (oder 1 Runde von 2 Helden gemeinsam), sobald die Zutaten zusammengetragen sind:

**Zutaten**: Ein Griff aus Holz, Metall oder Knochen; lumpenstoffartige Materialien zum Brennen; eine Ölflasche sowie *Feuerstein und Stahl* zum Anzünden.
...
**Gefahr fürs Licht**: GES-Probe SG 12, um bei Angriff o.ä. Erlöschen bzw. Fallenlassen zu vermeiden (nicht anfällig für Wind).

**Fallenlassen einer Laterne**: Wirf **1d6**:
- **1**: Explosion! Behandle das Feld, auf dem sie landet, wie einen Treffer mit einer *Brennenden Ölflasche*.
- **2–4**: Aus und zerbrochen. Das Licht erlischt sofort, die Laterne ist zerstört und das Öl ist verloren.
- **5–6**: Kein Effekt. Die Laterne übersteht den Sturz unbeschadet und brennt am Boden stehend weiter.

**Werfen einer *Brennenden Laterne***: Wirf eine brennende Laterne mit STR oder GES auf ein *nahes* Ziel (siehe Ölflasche), dann wirf **1d6**: 
...
- **Misserfolg**: Die Flasche landet angrenzend in *Direkt* (d8 für die Richtung), siehe Erfolg.
- **NAT-20**: Schaden verdoppelt auf 2d6.
- **NAT-1**: Flasche detoniert in der Hand des Werfers, siehe Erfolg.

**Zustand *Brennend***: Die Kreatur erleidet jeweils zu Beginn ihres Zuges **1d4 Feuerschaden**.

**Löschen**: Um *Brennend* zu beenden, muss die Kreatur ihre Aktion aufwenden und eine **GES-Probe gegen SG 12** bestehen (Hilfe durch Gefährten erlaubt *Vorteil*).

**Kettenreaktion:** Trägt eine brennende Kreatur weitere Ölflaschen, explodiert zu Beginn ihres Zuges **eine** dieser Flaschen: Sofort zusätzliche **1d6 Feuerschaden** (kein Rettungswurf) und GES-Probe zum Löschen in dieser Runde mit *Nachteil*.

**Fallenlassen einer brennenden Ölflasche**: Wirf **1d6**:
- **1-5**: Explosion! Behandle das Feld, auf dem sie landet, wie einen Treffer mit einer *Brennenden Ölflasche*.
- **6**: Kein Effekt. Glück gehabt, die Ölflasche übersteht den Sturz unbeschadet.
...
**Angriff**: Erfolgreicher Treffer verursacht Waffenschaden (siehe [[00 Digital Garden Publish/Regeln/Regeln für SL/Regeln für Spieler & SL#Kampf\|#Kampf]])

**Brennen**: 1d4 Schaden/Rd. bis Feuer mit Aktion und GES SG 12 gelöscht; siehe auch [[00 Digital Garden Publish/Regeln/Regeln für SL/Regeln für Spieler & SL#Ölflaschen\|#Ölflaschen]] und [[00 Digital Garden Publish/Regeln/Regeln für SL/Regeln für Spieler & SL#Laternen\|#Laternen]]
...
**Rast**: Erfolgreich abgeschlossene Rast regeneriert TP und Attributsschaden, siehe [[00 Digital Garden Publish/Regeln/Regeln für SL/Regeln für Spieler & SL#Unsichere Rast in Wildnis/Dungeon\|#Unsichere Rast in Wildnis/Dungeon]]
...
1. Werde *bewusstlos*, sei *Sterbend* und starte den Todestimer (siehe [[00 Digital Garden Publish/Regeln/Regeln für SL/Regeln für Spieler & SL#Sterben (Todestimer)\|#Sterben (Todestimer)]]).
...
- **Begegnung**: Sozial oder Kampf (siehe [[00 Digital Garden Publish/Regeln/Regeln für SL/Regeln für Spieler & SL#Kampf\|#Kampf]]) oder Kampf vermeiden
- **Verschnaufen**: Verschnaufen, Looten, Erste Hilfe, schnelles Essen / Trinken

### Kampfrunde

siehe [[00 Digital Garden Publish/Regeln/Regeln für SL/Regeln für Spieler & SL#Kampf\|#Kampf]]; Reihenfolge *Initiative*
